...
export default function App() {
  ...
  return (
    <div className="min-h-screen">
      <Header isPro={isPro} onGoPro={() => setIsProModalOpen(true)} />

      <main className="mx-auto flex max-w-5xl flex-col gap-6 px-4 py-8 sm:px-6">
        <DropZone onFilesAdded={handleFilesAdded} isPro={isPro} />

        <QualitySlider quality={quality} onChange={setQuality} isPro={isPro} onLockedClick={() => setIsProModalOpen(true)} />
      ...
      <footer className="mx-auto max-w-5xl px-4 pb-10 pt-2 text-center text-xs text-slate-400 dark:text-slate-500 sm:px-6">
        {t('footer.privacy')}
      </footer>
